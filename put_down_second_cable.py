...
def put_down_second_cable():
    ...
    def goto_drop():
        ...
        timed_follower(sensor=right_side_sensor, side_of_line=1, speed=20, kp=0.6, timemax=2)
        ...
        follow_for_xlines(3, sensor=right_side_sensor, side_of_line=1, ttarget=45, kp=0.15)
        steer_pair.off()
        lines_passed = False
