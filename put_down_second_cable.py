...
def put_down_second_cable():
    ...
    def goto_drop():
        ...
        timed_follower(sensor=right_side_sensor, side_of_line=1, speed=20, kp=1, timemax=1.5)
        ...
        follow_for_xlines(4, sensor=right_side_sensor, side_of_line=1, ttarget=45, kp=0.25)
        steer_pair.off()
        lines_passed = False
