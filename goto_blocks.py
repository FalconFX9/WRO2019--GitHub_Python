...
def goto_cables_group():
    ...
    def goto_cable():
        ...
        timed_follower(sensor=right_side_sensor, timemax=3.6, side_of_line=1, speed=85, kp=0.35, ttarget=50)
    ...
    def pick_up_cable():
        ...
        timed_follower(center_sensor, side_of_line=1, speed=30, timemax=0.95, kp=0.2)
        steer_pair.off()
        lower_motor.on_for_degrees(speed=10, degrees=-90)

    def turn_around():
        steer_pair.on_for_rotations(0, 40, 0.6)
        steer_pair.on_for_rotations(-70, 40, 1.8)
