...
def goto_cables_group():
    ...
    def goto_cable():
        ...
        timed_follower(sensor=right_side_sensor, timemax=3.6, side_of_line=1, speed=85, kp=0.25, ttarget=60)
    ...
    def pick_up_cable():
        ...
        timed_follower(center_sensor, side_of_line=1, speed=30, timemax=1.1, kp=0.3)
        steer_pair.off()
