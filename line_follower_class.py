...
def hisp_right_follower(side_of_line=None, speed=DEFAULT_SPEED):
    ...
    follow.follower(side_of_line=side_of_line, kp=0.15, speed=speed, sensor_target=35)
...
def timed_follower(sensor, timemax, side_of_line=None, speed=DEFAULT_SPEED):
    ...
    while time() < timemax:
        follower.follower(side_of_line=side_of_line, kp=0.15, speed=speed, sensor_target=25)
