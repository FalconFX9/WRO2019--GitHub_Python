...
def put_down_cable():
    ...
    def goto_drop():
        ...
        follow_to_line(line_sensor=right_side_sensor, speed=40, side_of_line=1, kp=0.3)
        steer_pair.off()
        ...
        steer_pair.off()
        left_motor.on_for_rotations(-40, 0.4)
        right_motor.on_for_rotations(-40, 0.4)
        # steer_pair.on_for_rotations(-30, -40, 0.5)
